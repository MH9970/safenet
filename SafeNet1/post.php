...
if (isset($_POST['submit_comment'])) {
    ...
    // Fetch latest comment with user info
...
$query = "SELECT p.*, l.f_name, l.l_name, l.photo AS user_photo 
          FROM post p JOIN log_in l ON p.log_id = l.log_id ORDER BY p.post_id DESC";
...
.post-header{ display:flex; align-items:center; gap:2px; }
.post-id{ font-size:12px; color:#555; }
.post-description{ width:100%; border:none; resize:none; outline:none; background:transparent; font-size:16px;margin-left:10px;margin-top:10px; }
